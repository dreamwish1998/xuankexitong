...
urlpatterns = [
    ...
    path('add_s_optionlesson/', views.Add_s_Optionlesson, name="Add_s_OptionLesson"),
    ...
    path('delete_s_optionlesson/', views.Delete_s_OptionLesson, name="Delete_s_OptionLesson"),
    ...
    path('student_init/', views.Init_Student, name="Init_student"),
    path('teacher_index/', views.Get_Teacher_status, name="Teacher_status"),
    path('student_index/', views.Get_Student_status, name="Student_status"),
